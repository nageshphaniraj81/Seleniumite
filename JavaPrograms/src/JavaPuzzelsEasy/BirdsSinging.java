...
import JavaPuzzelsEasyUT.BirdsSingingUT;

public class BirdsSinging {

	/**
	 * The birds in Florida like to sing during favorable temperatures. In
	 * particular, they sing if the temperature is between 60 and 90
	 ...
	 * birds are singing and false otherwise. <br>
	 * <br>
	 * 
	 * <b>EXPECTATIONS:</b><br>
